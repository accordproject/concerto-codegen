...
class GraphQLVisitor {
    ...
    */
    visitClassDeclaration(classDeclaration, parameters) {
        ...
        // Ensure we have at least one member. GraphQL object and enum types
        // cannot be empty - see https://github.com/graphql/graphql-spec/issues/568
        // workaround from https://github.com/graphql/graphql-spec/issues/568#issuecomment-468788779
        if(classDeclaration.getProperties().length === 0) {
            if(classDeclaration.isEnum()) {
                parameters.fileWriter.writeLine(1, '_' );
            } else {
