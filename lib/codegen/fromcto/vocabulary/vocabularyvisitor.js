...
class VocabularyVisitor {
    ...
    visitField(field, parameters) {
        ...
        const fieldVocabulary = VocabularyManager.englishMissingTermGenerator(null, null, classDeclarationName, fieldName);

        parameters.fileWriter.writeLine(0, `      - ${fieldName}: ${fieldVocabulary}`);
