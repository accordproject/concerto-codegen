...
const MODEL_SIZE_LIMIT = 104857600; // 100 MiB.
...
class BenchmarkModelGenerator {
    ...
    generateConcertoModels({
        ...
        if (generateUpToSize > MODEL_SIZE_LIMIT) {
            throw new Error('The requested model size exceeds the 100 MiB limit and cannot be created.');
        }
