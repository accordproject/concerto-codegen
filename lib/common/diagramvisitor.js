...
class DiagramVisitor {
    ...
    visitClassDeclaration(classDeclaration, parameters, type = 'concept') {
        ...
        this.handleDecorators(classDeclaration, parameters);
    }
    ...
    visitDecorator(decorator, parameters) {
        parameters.fileWriter.writeLine(1, '+ ' + decorator.getName());
    }
     ...
     * @protected
     */
    handleDecorators(classDeclaration, parameters) {
        const decorators = [
            ...classDeclaration.getDecorators(), // Class-level decorators
            ...classDeclaration.getOwnProperties().flatMap(property => property.getDecorators()) // Property-level decorators
        ];
