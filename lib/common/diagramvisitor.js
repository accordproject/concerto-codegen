...
class DiagramVisitor {
    ...
    visitModelFile(modelFile, parameters) {
        ...
        this.handleDecorators(modelFile.getDecorators(), parameters);
    }
    ...
    visitClassDeclaration(classDeclaration, parameters, type = 'concept') {
        ...
        this.handleDecorators(classDeclaration.getDecorators(), parameters);
    }
    ...
    visitScalarDeclaration(scalarDeclaration, parameters) {
        this.handleDecorators(scalarDeclaration.getDecorators(), parameters);
        return;
    }
    ...
    visitMapDeclaration(mapDeclaration, parameters) {
        this.handleDecorators(mapDeclaration.getDecorators(), parameters);
        return;
    }
    ...
    visitScalarField(field, parameters) {
        ...
        this.handleDecorators(field.getDecorators(), parameters);
    }
    ...
    visitEnumValueDeclaration(enumValueDeclaration, parameters) {
        this.handleDecorators(enumValueDeclaration.getDecorators(), parameters);
    ...
    /**
     * Visitor design pattern
     * @param {Decorator[]} decorators - the objects being visited
     * @param {Object} parameters  - the parameter
     * @protected
     */
    handleDecorators(decorators, parameters) {
        decorators.forEach(decorator => decorator.accept(this, parameters));
    }
}
