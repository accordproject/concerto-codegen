 ...
 *
 * `skip` may be a string (all targets) or `{ typescript: '...', jsonschema: '...', protobuf: '...', graphql: '...', csharp: '...', rust: '...', java: '...',  golang: '...', xmlschema: '...', openapi: '...', avro: '...', plantuml: '...', vocabulary: '...', markdown: '...' }`.
 */
const CASES = [
    {
        name: 'metamodel',
