...
/**
 * Return the skip reason for a verification target, if any.
 * @param {Object} testCase - the verification case
 * @param {string} target - the verification target name
 * @return {string|null} the skip reason, or null when the case should run
 */
 ...
 * @param {Object} testCase - the verification case
 * @return {ModelManager} the populated model manager
 */
...
/**
 * Enable environment flags used by verification code generation.
 */
